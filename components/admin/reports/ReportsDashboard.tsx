          ...
          <div className="flex items-center gap-4 w-full md:w-auto">
            <div className="flex-1 md:flex-none">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full md:w-64 bg-slate-800 border border-slate-700 rounded-lg pl-9 pr-3 py-2 text-white text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50 appearance-none"
                >
            ...
            <div className="flex-1 md:flex-none">
              ...
              <div className="relative">
                ...
                <select className="w-full md:w-48 bg-slate-800 border border-slate-700 rounded-lg pl-9 pr-3 py-2 text-white text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50 appearance-none">
          ...
          {reports.map((report) => (
            <div key={report.id} className="border border-slate-800 rounded-xl p-5 bg-slate-900/50 hover:bg-slate-800/50 transition-colors flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between group">
              ...
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 bg-slate-800 hover:bg-emerald-600 group-hover:text-white text-slate-300 rounded-lg text-sm font-medium transition-colors"
              >
